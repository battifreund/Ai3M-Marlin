...
#define STRING_CONFIG_H_AUTHOR "Sebastian Freund" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // i3 Mega E3D V5 Hotend 
  // #define  DEFAULT_Kp 13.4
  // #define  DEFAULT_Ki 0.77
  // #define  DEFAULT_Kd 58.19

  // i3 Mega E3D V6 Hotend 
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 29, -15, -2.54 } // Offset MK4 X Carriage https://www.thingiverse.com/thing:3537449
...
#define RGBW_LED
  ...
  #define RGB_LED_R_PIN 45
  #define RGB_LED_G_PIN 45
  #define RGB_LED_B_PIN 45
  #define RGB_LED_W_PIN 45
#endif
